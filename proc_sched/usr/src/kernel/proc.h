...
#define NO_OF_GROUPS 3 /* there are 3 user groups */
#define IO_GROUP 0 /* input-output group has number 0 */
#define CALC_GROUP 1 /* calculating group has number 1 */
#define INTER_GROUP 2 /* interactive group has number 2 */
...
struct proc {
  ...
  int group; /* group of the process */
  int times_called; /* counter of how many times this process has been called */
};
